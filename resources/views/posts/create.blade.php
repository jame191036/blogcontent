        ...
        <div class="card-body">
            <form action="{{isset($post) ? route('posts.update',$post->id) : route('posts.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="" value="{{isset($post) ? $post->title : ''}}" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="submit" name="" id="" value="{{isset($post) ? "Update post" : "Create post"}}" class="btn btn-success">
                </div>
            </form>
        </div>
    </div>
